  ...
  return (
    <div className="h-[15%] mt-16 bg-white p-2 opacity-75  flex md:justify-between flex-col  md:flex-row  items-center">
      <div className="flex justify-between items-center">
        ...
        <span className="text-gray-700 "> &#169; 2024 SharedBoard</span>
      </div>
      ...
      <div className=" flex flex-col">
        ...
        <div className="flex justify-around items-center">
          <a href={"https://www.linkedin.com/in/rohan-dhiman-2bb4b6305/"}>
            <img className="w-[20px] " src={linkedin} alt="img" />
          </a>
          
          <a href={"https://www.instagram.com/imrohandhiman/"}>
            <img className="w-[20px]" src={insta} alt="img" />
          </a>
          <a href={"mailto: rohandhiman.1211@gmail.com"}>
